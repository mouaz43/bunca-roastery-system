...
// Login / Logout (supports different naming styles)
router.get(
  "/login",
  safe(
    pageController.renderLogin || pageController.login || pageController.getLogin,
    "pageController.renderLogin"
  )
);
...
router.post(
  "/login",
  safe(
    pageController.handleLogin || pageController.postLogin || pageController.loginPost,
...
router.post(
  "/logout",
  safe(
    pageController.handleLogout || pageController.logout || pageController.postLogout,
